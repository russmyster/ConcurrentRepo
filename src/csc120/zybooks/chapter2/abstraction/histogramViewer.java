package csc120.zybooks.chapter2.absraction;
...
public class histogramViewer extends JComponent {

    public static void main(String[] args){
        JFrame histFrame = new JFrame();

        histFrame.setTitle("Histogram Viewer");
        histFrame.setSize(800,500);
