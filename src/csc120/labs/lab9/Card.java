 ...
 *
 * <p>
 * Description: Description: This class will represent a single playing card
 ...
 * String containing the card's value and suit. It can check to see if two cards
 * have the same value or the same suit or if a card is a face card.
 * </p>
 * 
...
public class Card {
    ...
    /**
     * parameterized Card constructor -- gets called when an object of the Card
     * class is instantiated sending a number as an argument -- it determines
     * the value and suit of the card based upon the number received
     * 
     * @param num
     *            a number that gets converted to a value between 1 and 13 and a
     *            suit
     */
    public Card( int num ) {
        int suitNumber;
    ...
    /**
     * equalValue method -- determines if the otherCard's value is the same as
     * this card's value
     * 
     * @param otherCard
     *            a reference to the Card object (assumes the object has been
    ...
    /**
     * getPointValue method -- returns the point value for the card -- 11 if Ace
     * is high, 1 if Ace is low, 10 for a face card, the actual value for cards
     * 2 through 10
     * 
     * @param aceHigh
     *            true if the ace has a high value of 11, false if it has a low
     *            value of 1
     ...
     * 
     * @param otherCard
     *            a reference to a Card object (assumes the object has been
     *            instantiated) to compare to this Card object
